            ...
            <div class="fade-in">
                <form method="post" action="" autocomplete="off">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header"><strong>Cấu hình top game</strong></div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h5>Chọn vị trí</h5>
                                            <div class="row mb-1">
                                                <div class="form-group col-9">
                                                    <select class="form-control sl-position">
                                                        @foreach($arr_type as $key => $title)
                                                            <option @if($key == $type) selected @endif data-url="/admin/top_game/{{$key}}">{{$title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
